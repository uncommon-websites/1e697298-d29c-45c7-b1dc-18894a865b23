...
<header class="fixed top-0 left-0 w-full z-50 px-5 py-6 md:px-10 md:py-8 flex justify-between items-start bg-white/90 backdrop-blur-sm transition-all duration-300 text-black">
  <a href="/" class="flex items-center gap-3 z-10 hover:opacity-80 transition-opacity">
    ...
    <span class="text-xl md:text-2xl font-normal tracking-wide">OneSkin</span>
  </a>
  ...
  <button class="hover:opacity-70 transition-opacity z-10" aria-label="Cart">
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M9 2L7.17 4H3C1.9 4 1 4.9 1 6V20C1 21.1 1.9 22 3 22H21C22.1 22 23 21.1 23 20V6C23 4.9 22.1 4 21 4H16.83L15 2H9Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
